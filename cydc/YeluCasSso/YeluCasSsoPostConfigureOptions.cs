...
{
    public partial class YeluCasSsoPostConfigureOptions : IPostConfigureOptions<YeluCasSsoOptions>
    {
        private readonly IDataProtectionProvider _dp;

        public YeluCasSsoPostConfigureOptions(IDataProtectionProvider dataProtection)
        {
            _dp = dataProtection;
        }
